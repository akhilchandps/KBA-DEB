    ...
    <div className="row md:flex md:justify-around align-center">
      ...
      <div className="col md:w-96 w-full  bg-[#024550] md:h-[101vh] h-[600px]">
          <div className="flex md:justify-between justify-center md:mt-14 mb-5 w-[165px] md:m-5">
            ...
            <a href="./Dashboard.html" className="text-3xl font-bold text-white text-center">Welcome<span className='ml-2 text-orange-600'>{user}</span>!</a>
          </div> 
          <hr/>
          <div className=" items-center md:flex-row mt-12">
            <button onClick={handleLogout} className="dropbtn md:text-xl text-sm font-bold  text-white "><i className="fa-solid fa-landmark mx-5 text-white"></i>Log Out</button>
