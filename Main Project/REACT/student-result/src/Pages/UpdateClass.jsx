...
const UpdateClass = () => {
  ...
  const getClass = async () => {
    const response = await fetch(`http://127.0.0.1:5000/getClass/${id}`, {
      method: "GET",
      credentials: "include",
    });
  ...
  const handleUpdate = async (e) => {
    ...
    const response = await fetch(`http://127.0.0.1:5000/updateClass/${id}`, {
      method: "PUT",
      credentials: "include",
      headers: {
          ...
          >
            ...
            <div className="my-3">
              <input
                ...
                className="h-8 w-full pl-3 text-black"
              />
              <p className="text-gray-500">Eg: A, B, C etc</p>
            </div>
